...
class EventHandler:
    ...
    def handle_click(self, pos: Tuple[int, int], game: Game) -> bool:
        ...
        if game.phase == "Execution":
            ...
            # Execution Debug panel is inspectable even while trade panels are open.
            # TwP/TwB dialogs are modal for game actions, but debug-tab clicks are
            # display-only and must not be swallowed by the trade dialog handlers.
            try:
